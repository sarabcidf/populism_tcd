...
data = data[data['gps_ISO'].isin(['BOL', 'COL', 'CHL', 'MEX', 'PER'])]
data = data = data.sample(n=100000, random_state=1)
...
p_train = 0.7
random_state = 1
n_jobs = 4 # Authors originally use 8 (I only got 8 total)
...
with open('best_random_forest_model_filt_bin.pkl', 'wb') as file:
...
# %% Loading model to explore... 

with open('best_random_forest_model_filt_bin.pkl', 'rb') as file:
